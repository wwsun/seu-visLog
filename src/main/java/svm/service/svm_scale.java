...
public class svm_scale {
	...
	// �Զ�������scale����ļ�
	private String scale_filename = null;
	...
	private static void exit_with_help() {
		System.out
				.print("Usage: svm-scale [options] data_filename\n"
						...
						+ "-o scale_filename : store scaling results to scale_filename\n");
		System.exit(1);
	}
	...
	private void output_target(double value) {
		...
		//�Զ���
		try{
			BufferedWriter bw=new BufferedWriter(new FileWriter(scale_filename,true));
			bw.append(value + " ");
			bw.close();
		}
		catch(Exception e){
